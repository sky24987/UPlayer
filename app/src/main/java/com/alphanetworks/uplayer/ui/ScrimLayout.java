...
public class ScrimLayout extends RelativeLayout {
    ...
    public ScrimLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public ScrimLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public ScrimLayout(Context context, AttributeSet attrs, int defStyle) {
