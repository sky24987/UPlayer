...
public class ContentTree {
	...
	protected static ContentNode createRootNode() {
		...
		rootContainer.setId(UpnpUtils.CONTENT_ROOT_ID);
		rootContainer.setTitle(Utils.APP_NAME);
		rootContainer.setCreator(UpnpUtils.MANUFACTURER);
		...
		ContentNode rootNode = new ContentNode(UpnpUtils.CONTENT_ROOT_ID,
				rootContainer);
	...
	public static void addRootContentNode() {
		if (!mHashMap.containsKey(UpnpUtils.CONTENT_ROOT_ID))
			mHashMap.put(UpnpUtils.CONTENT_ROOT_ID, mRemoteRootContentNode);
		if (!mLocalHashMap.containsKey(UpnpUtils.CONTENT_ROOT_ID))
			mLocalHashMap.put(UpnpUtils.CONTENT_ROOT_ID, mLocalRootContentNode);
	}
